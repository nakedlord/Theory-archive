...
```text
two-layer: active governance infrastructure + reflexive runtime theory (patch v5.3)
```

Он не является объектной теорией **мира**, но его runtime-слой является рефлексивной теорией **мышления** (генеративное ядро производит содержание; объект меняется от изучения).

Governance-слой является архитектурой управления:
