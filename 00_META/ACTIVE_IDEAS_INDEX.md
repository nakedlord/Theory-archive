...
| human-thought-reconstruction | Human Thought Reconstruction from the Total Artifact Record | active_research_program / non-canon / needs_source_verification | Human Thought Reconstruction, R Theory, Culture as Instructions, MEAT, CID, PNA | `10_HUMAN_THOUGHT_RECONSTRUCTION/HYPOTHESES/2026-06-01_total_artifact_record_research_program.md` | high | Build the first comparison case across stone tools, writing/notation, and software/interface; separate artifact form, operation, carrier, transmission, inferred distinction, confidence, and alternatives. |
