...
| r3-modes-instruction-runtime | R3 Modes and Instruction Runtime | review_completed / canon_review_candidate_split / not_canon | R Theory, Culture as Instructions, SynTax, PNA, GYMKiDs route | `01_R_THEORY/PATCHES/2026-05-28_r3_modes_instruction_runtime_review.md` | high | Split next: R Theory canon-compression review for learning displacement + compact R3 modes; Culture/SynTax/PNA/GYMKiDs route artifacts for instruction runtime, Q-R3, motivational field, and applied methodology. |
