...
| ariadne-precognition-learning-loop | Ariadne Precognition Learning Loop | operator_candidate / self-improvement_method / non-canon | SynTax, CSP, Agent Playbook, codex-ops | `02_SYNTAX/OPERATORS/ariadne_precognition_learning_loop.md`; `02_SYNTAX/SOURCES/2026-06-01_ariadne_precognition_learning_source_cards.md` | high | Pilot the learning packet on one external AI-agent paper, one user theory artifact, and one recent agent/CSP failure; promote only if it creates a real behavior delta without weakening CSP gates. |
