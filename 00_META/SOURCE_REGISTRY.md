...
| `rtheory-2026-05-28-r3-modes-instruction-runtime-review` | `repo_artifact` | review_completed / canon_review_candidate_split / not_canon | `01_R_THEORY/PATCHES/2026-05-28_r3_modes_instruction_runtime_review.md` | Review artifact for the R3 modes / instruction runtime candidate patch. Elevates compact R3 modes to canon-review candidate status, keeps canon unchanged, and requires route split for instruction runtime, Q-R3, PNA motivational field, and GYMKiDs applied methodology. |
| `rtheory-2026-05-28-r3-modes-canon-compression-packet` | `repo_artifact` | canon_compression_packet / ready_for_human_acceptance / not_canon | `01_R_THEORY/PATCHES/2026-05-28_r3_modes_canon_compression_packet.md` | Closure packet for the internal R3 review pass. It isolates the exact proposed canon wording for R levels as displaced learning and R3-A/B/C operating modes, while excluding instruction runtime, Q-R3, decoherence, R4, and applied GYMKiDs methodology from R core canon. |
